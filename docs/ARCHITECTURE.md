...
| `src/webview/pdf.ts`             | The PDF preview: virtualised pdf.js rendering (canvas + text layer, zoom, dark/green bitmap recolouring, the shared Theme menu), per-page text extraction, comment pins, and the copy actions (page PNG, page text, all text, selected text).                          |
